...
// private static final String USAGE = "<html><body width=\"400\">You are running MapTool with
// insufficient memory allocated (%dMB).<br><br>"
// + "You may experience odd behavior, especially when connecting to or hosting a server.<br><br> "
// + "MapTool will launch anyway, but it is recommended that you increase the maximum memory
// allocated or don't set a limit.</body></html>";
//
// static {
...
//
// /*
// * Asking for 256MB via the -Xmx256M switch doesn't guarantee that the amount maxMemory() reports
// will be 256MB. The actual amount seems to vary from PC to PC. 200MB seems to be a safe value
// * for now. <Phergus>
// */
