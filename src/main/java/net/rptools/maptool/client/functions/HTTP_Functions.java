 ...
 *
 * <p>requestURL(URL) :: Takes a URL as a string and sends a GET request, returning HTTP data.
 * sendURL(URL, Parameters) :: Takes a URL as a string and a JSON array of Parameters and sends s
 * POST request, returning HTTP data.
 *
