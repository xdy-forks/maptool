/*
 * This software copyright by various authors including the RPTools.net development team, and
 * licensed under the LGPL Version 3 or, at your option, any later version.
 *
 * Portions of this software were originally covered under the Apache Software License, Version 1.1
 * or Version 2.0.
 *
...
public class SplashScreenSwing extends JFrame implements ISplashScreen {
    ...
    public SplashScreenSwing(String imgName, final String versionText, int versionTextX, int versionTextY) {
        this(imgName, versionText, versionTextX, versionTextY, new Color(27, 85, 139));
    }

    public SplashScreenSwing(String imgName, final String versionText, final int versionTextX, final int versionTextY, final Color versionColor) {
        setUndecorated(true);
    ...
    public void loadSplashImage(String imgName) {
        ...
        splashImage = Toolkit.getDefaultToolkit().createImage(SplashScreenSwing.class.getClassLoader().getResource(imgName));
