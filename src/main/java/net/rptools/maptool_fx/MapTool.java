...
public class MapTool extends Application {
  ...
  public void init() throws Exception {
    ...
    graphicsMonitor =
        CommandLineOptionHelper.getCommandLineOption(cmdOptions, "monitor", graphicsMonitor, args);
    useFullScreen = CommandLineOptionHelper.getCommandLineOption(cmdOptions, "fullscreen", args);

    windowWidth =
        CommandLineOptionHelper.getCommandLineOption(cmdOptions, "width", windowWidth, args);
    windowHeight =
        CommandLineOptionHelper.getCommandLineOption(cmdOptions, "height", windowHeight, args);
    ...
    // messages to source.
    if (debug) DebugStream.activate();
    else DebugStream.deactivate();
  ...
  public void start(Stage primaryStage) throws IOException {
    ...
    FXMLLoader fxmlLoader =
        new FXMLLoader(
            getClass().getResource(MAPTOOL_FXML),
    ...
    primaryStage
        .getIcons()
        .add(new Image(getClass().getResourceAsStream(AppConstants.MAP_TOOL_ICON)));
   ...
   *
   * <p>Now that we are packing the JRE with MapTool this is normally not required, however for
   * Development and running the JAR manually, we need the check. MapTool is written for OpenJDK 11
   * + OpenJFX
   */
  ...
  private static void initialize() {
    ...
    messageList =
        new MapToolObservableList<TextMessage>(
  ...
  public static void showMessage(
      String message, String titleKey, AlertType messageType, Object... params) {
   ...
   * @return <code>true</code> if the user clicks the OK button, <code>false</code> otherwise
   */
  public static ButtonType confirmImpl(
      String title, ButtonType buttons, String message, Object... params) {
    String msg = I18N.getText(message, params);
    ...
    if (buttons == ButtonType.CANCEL) alert.getButtonTypes().add(ButtonType.CANCEL);
          ...
          public void customize(UIDefaults defaults) {
            ...
            defaults.put(
                ...
                painter != null
                    ...
                    : null); // you should adjust this if
