...
public class DockingManagerStub {
  ...
  public void hideFrame(String name) {
    showDialog("Docking Manager Stub", "DockingManagerStub.hideFrame()", "Frame Name = " + name);
  }

  public void showFrame(String name) {
    showDialog("Docking Manager Stub", "DockingManagerStub.showFrame()", "Frame Name = " + name);
  }

  public void resetToDefault() {
    showDialog("Docking Manager Stub", "DockingManagerStub.resetToDefault()", null);
  }
  ...
  public void floatFrame(String key, Rectangle rect, boolean b) {
    showDialog("Docking Manager Stub", "DockingManagerStub.floatFrame()", "key = " + key);
  }
  ...
  public DockableFrame getFrame(String name) {
    if (showOnlyOnce.contains(name)) {
      ...
      showDialog("Docking Manager Stub", "DockingManagerStub.getFrame()", "Name = " + name);
    }
    return null;
  }
}
